function event = frictionterminalcond_curves(y,tauA,tauB,cond,wheel,params,curves)
%% frictionterminalcond_curves
...
[~, FN_coeff, theta_coeff] = curves_dynamicsselectorfunction(y,cond,wheel,params,curves);
