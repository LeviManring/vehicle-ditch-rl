function [tevent, yevent, failed, nozero] = nr_eventdetectionAWD(odehandle, eventhandle, init_interval, init_conds, max_err, max_steps, t_final)
%% nr_eventdetectionAWD
...
while err > max_err
    ...
    eventdata = eventhandle(y_nr(end,:));
    eventk = eventdata(1);
    deventk = eventdata(2);
