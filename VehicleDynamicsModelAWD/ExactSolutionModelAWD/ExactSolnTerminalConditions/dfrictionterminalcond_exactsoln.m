function eventdata = dfrictionterminalcond_exactsoln(y,tauA,tauB,cond,wheel,guess_Dx,params)
%% dfrictionterminalcond_exactsoln
...
for k = 1:length(Dvec)
    ...
    [x_coeff, FN_coeff, theta_coeff] = exactsoln_dynamicsselectorfunction(ymod,cond,wheel,guess_Dx,params);
...
% calculate Ffrction and dFfriction depending on which wheel
