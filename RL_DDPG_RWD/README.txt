...
This folder contains the RL framework using DDPG and assuming an RWD dynamic model with rear wheel drive and wheel slippage. It includes the: 
...
To get STARTED: open RWDlearn.m and run.