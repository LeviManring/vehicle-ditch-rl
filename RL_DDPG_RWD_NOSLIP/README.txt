...
This folder contains the RL framework using DDPG and assuming an RWD dynamic model with rear wheel drive and no wheel slippage. It includes the: 
...
To get STARTED: open RWDNOSLIPlearn.m and run.