...
ObservationInfo.Description = 'x, xdot';
...
params.dt = 0.1;
Time_to_run = 22; % seconds
steps_to_run = Time_to_run*(1/params.dt) + 1;
episodecount = 5000;
params.experience = steps_to_run*episodecount;

% Define the reset and step functions
ResetHandle = @() myNoSlipResetFunction(params);
StepHandle = @(Action,LoggedSignals) myNoSlipStepFunction(Action,LoggedSignals,params,curves);
